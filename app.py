...
if selected == "Filter criteria":
                             ...
                             min_mag = st.slider("magnitude",13.8,32.61,(13.8,32.61))
                             lunar_dist = st.slider("miss_distance_lunar", 1.5, 100.0, (1.5, 100.0))
                             ...
                             if button:
                                 ...
                                 filtered_asteroid_results = df.drop_duplicates(subset='id')
                                 st.dataframe(filtered_asteroid_results)
